...
{
    public Code code;
    private final SymbolTableBuilder stb;
    private int nTemp;
    private int nLabel;
    ...
    public IR(ProgramNode prog, SymbolTableBuilder stb)
    {
        this.nTemp = 0;
        this.nLabel = 0;
        this.stb = stb;
    ...
    public Code visitProgramNode(ProgramNode node)
    {
        ...
        if (main != null)
        {
            ...
            // PUSH END RETURN ADDRESS

            TAC pEnd = new TAC();
            pEnd.opCode = OpCode.PUSH;
            pEnd.op1 = end.op1;
    ...
    public Code visitCallExprNode(CallExprNode node)
    {
        ...
        TAC retLabel = new TAC();
        retLabel.opCode = OpCode.LABEL;
        retLabel.op1 = this.newLabel();

        TAC pushRet = new TAC();
        pushRet.opCode = OpCode.PUSH;
        pushRet.op1 = retLabel.op1;
        ...
        // FUNCTION JUMP + RETURN LABEL

        TAC fJump = new TAC();
        fJump.opCode = OpCode.JUMP;
        fJump.op1 = new Operand(node.id);
